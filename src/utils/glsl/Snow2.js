export default `
    ...
    vec2 mod289(vec2 x) {
		...
		void main( void )
		{
				...
				slope=(slope-(slope*0.1))*0.6;
				slope=clamp(slope,0.0,1.0);

				vec2 GA;
				GA.x+=czm_frameNumber/80.0;
				GA.y+=czm_frameNumber/80.0;
				GA*=speed;
				...
				Snowout = 0.35+N1+N2+N3+N4+N5;

                out_FragColor = mix(texture(colorTexture, v_textureCoordinates), vec4(Snowout*0.9, Snowout, Snowout*1.1, 1.0),0.3);
		}
`;