...
float cloudHeight = 1.5; 	// (inverse) height of the input gradient [0,...)
...
void main()
{
    ...
    vec3 p = vec3(uv, czm_frameNumber*0.025 * speed);
    ...
    out_FragColor = mix(texture(colorTexture, v_textureCoordinates), vec4(q,q,q, 0.8), 0.2);
}
`;